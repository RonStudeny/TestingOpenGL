    ...
    public static class Glfw
    {
        ...
        public static Monitors[] Monitors
        {
            get
            {
                ...
                var monitors = new Monitors[count];
                var offset = 0;
                for (var i = 0; i < count; i++, offset += IntPtr.Size)
                {
                    monitors[i] = Marshal.PtrToStructure<Monitors>(ptr + offset);
                }
        ...
        /// </summary>
        /// <value>
        ///     The primary monitor, or <see cref="Monitors.None" /> if no monitors were found or if an error occurred.
        /// </value>
        public static Monitors PrimaryMonitor => GetPrimaryMonitor();
        ...
        private static extern Window CreateWindow(int width, int height, byte[] title, Monitors monitor, Window share);
        ...
        ///     </para>
        ///     <para>
        ///         When the monitor is <see cref="Monitors.None" />, the position, width and height are used to place the window
        ...
        /// </summary>
        /// <param name="window">A window instance.</param>
        /// <param name="monitor">The desired monitor, or <see cref="Monitors.None" /> to set windowed mode.</param>
        ...
        public static extern void SetWindowMonitor(Window window, Monitors monitor, int x, int y, int width, int height,
            int refreshRate);

        [DllImport(LIBRARY, EntryPoint = "glfwGetGammaRamp", CallingConvention = CallingConvention.Cdecl)]
        internal static extern IntPtr GetGammaRampInternal(Monitors monitor);
        ...
        public static extern void SetGammaRamp(Monitors monitor, GammaRamp gammaRamp);
        ...
        public static extern void SetGamma(Monitors monitor, float gamma);
        ...
        private static extern IntPtr GetMonitorNameInternal(Monitors monitor);
        ...
        public static extern void GetMonitorPhysicalSize(Monitors monitor, out int width, out int height);
        ...
        public static extern void GetMonitorPosition(Monitors monitor, out int x, out int y);
        ...
        /// <param name="monitor">The monitor to use for full screen mode, or <see cref="Monitors.None" /> for windowed mode.</param>
        /// <param name="share">
        ...
        public static Window CreateWindow(int width, int height, [NotNull] string title, Monitors monitor, Window share)
        {
        ...
        public static GammaRamp GetGammaRamp(Monitors monitor)
        {
        ...
        public static string GetMonitorName(Monitors monitor)
        {
        ...
        public static VideoMode GetVideoMode(Monitors monitor)
        {
        ...
        public static VideoMode[] GetVideoModes(Monitors monitor)
        {
