...
namespace GLFW
{
    ...
    public class NativeWindow : SafeHandleZeroOrMinusOneIsInvalid, IEquatable<NativeWindow>
    {
        ...
        ///     <para>Returns <see cref="GLFW.Monitors.None" /> if window is not fullscreen.</para>
        /// </summary>
        /// <value>
        ///     The monitor.
        /// </value>
        public Monitors Monitor => Glfw.GetWindowMonitor(Window);
        ...
        public VideoMode VideoMode
        {
            ...
            {
                var monitor = Monitor;
                return Glfw.GetVideoMode(monitor == Monitors.None ? Glfw.PrimaryMonitor : monitor);
            }
        }
        ...
        /// </summary>
        public NativeWindow() : this(800, 600, string.Empty, Monitors.None, Window.None)
        {
        }
        ...
        public NativeWindow(int width, int height, [CanBeNull] string title) : this(width, height, title, Monitors.None,
            Window.None)
        {
        }
        ...
        /// <param name="height">The desired height, in screen coordinates, of the window. This must be greater than zero.</param>
        /// <param name="title">The initial window title.</param>
        /// <param name="monitor">The monitor to use for full screen mode, or <see cref="GLFW.Monitors.None" /> for windowed mode.</param>
        /// <param name="share">
        ///     A window instance whose context to share resources with, or <see cref="GLFW.Window.None" /> to not share
        ///     resources..
        /// </param>
        public NativeWindow(int width, int height, [CanBeNull] string title, Monitors monitor, Window share) : base(true)
        {
        ...
        public void CenterOnScreen()
        {
            if (Maximized)
                return;
            var monitor = Monitor == Monitors.None ? Glfw.PrimaryMonitor : Monitor;
        ...
        public void Fullscreen(Monitors monitor)
        {
        ...
        ///     <para>
        ///         If <paramref name="monitor" /> is not <see cref="GLFW.Monitors.None" />, the window will be full-screened and
        ///         dimensions ignored.
        ///     </para>
        /// </summary>
        /// <param name="monitor">The desired monitor, or <see cref="GLFW.Monitors.None" /> to set windowed mode.</param>
        ...
        public void SetMonitor(Monitors monitor, int x, int y, int width, int height,
