...
namespace GLFW
{
    ...
    public static class Native
    {
        ...
        public static extern uint GetCocoaMonitor(Monitors monitor);
        ...
        public static extern IntPtr GetWaylandMonitor(Monitors monitor);
        ...
        public static extern IntPtr GetX11Monitor(Monitors monitor);
        ...
        public static extern IntPtr GetX11Adapter(Monitors monitor);
        ...
        private static extern IntPtr GetWin32AdapterInternal(Monitors monitor);

        [DllImport(Glfw.LIBRARY, EntryPoint = "glfwGetWin32Monitor", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr GetWin32MonitorInternal(Monitors monitor);
        ...
        public static string GetWin32Adapter(Monitors monitor)
        {
        ...
        ///     error occurred.
        /// </returns>
        public static string GetWin32Monitor(Monitors monitor)
        {
