...
namespace GLFW.Game
{
    ...
    public class GameWindow : NativeWindow
    {
        ...
        /// <inheritdoc cref="NativeWindow(int, int, string, Monitors, Window)"/>
        [Obsolete("Use NativeWindow, GameWindow will be removed in future release.")]
        public GameWindow(int width, int height, string title, Monitors monitor, Window share) : base(width, height,
            title, monitor, share)
        {
        }
    }
